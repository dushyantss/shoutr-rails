...
ActiveRecord::Schema.define(version: 2021_09_19_185607) do
  ...
  create_table "following_relationships", force: :cascade do |t|
    ...
    t.index ["follower_id", "followed_user_id"], name: "idx_following_relationships_on_fid_and_fuid", unique: true
